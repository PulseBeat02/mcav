...
// Pass 8: the outline target without the data frames. The frames that carry the pages glow, which is what makes the
...
void main() {
    ...
    ivec3 color = ivec3(floor(outline.rgb * 255.0 + 0.5));
