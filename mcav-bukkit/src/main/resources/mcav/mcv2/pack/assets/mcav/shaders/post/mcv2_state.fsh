...
// Pass 6: the decoder state, kept in a persistent target, four texels: (1 when a picture was decoded, plus 2 when a
...
void main() {
    ...
    if (x == 0) {
        uint flags = uint(floor(kept.x * 255.0 + 0.5)) | 1u | (keyframe ? 2u : 0u);
