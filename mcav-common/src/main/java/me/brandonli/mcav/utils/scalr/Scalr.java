...
public class Scalr {
  ...
  public static BufferedImage apply(BufferedImage src, final BufferedImageOp... ops) throws IllegalArgumentException, ImagingOpException {
    ...
    for (int i = 0; i < ops.length; i++) {
       ...
       */
      final BufferedImage dest = createOptimalImage(
        src,
  ...
  public static BufferedImage pad(final BufferedImage src, final int padding, final Color color, final BufferedImageOp... ops)
    ...
    final boolean imageHasAlpha = (src.getTransparency() != BufferedImage.OPAQUE);
   ...
   * to Morten Nobel for implementation hint</a>
   */
  protected static BufferedImage createOptimalImage(final BufferedImage src, final int width, final int height)
