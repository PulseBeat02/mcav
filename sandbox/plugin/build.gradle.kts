...
dependencies {
    ...
    runtimeDownload("org.incendo:cloud-paper:2.0.0-beta.16")
    runtimeDownload("org.incendo:cloud-minecraft-extras:2.0.0-beta.16")

    runtimeDownload("me.lucko:commodore:2.2")
    runtimeDownload("org.bstats:bstats-bukkit:3.2.1")
    runtimeDownload("net.dv8tion:JDA:6.4.2")
    runtimeDownload("io.javalin:javalin:7.2.2")
}
