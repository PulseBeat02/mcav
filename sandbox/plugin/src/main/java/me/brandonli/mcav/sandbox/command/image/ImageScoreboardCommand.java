...
public final class ImageScoreboardCommand extends AbstractImageCommand {
  ...
  public void showScoreboardImage(
    ...
    final ImageConfigurationProvider configProvider = resolution -> this.constructScoreboardConfiguration(resolution, character, players);
