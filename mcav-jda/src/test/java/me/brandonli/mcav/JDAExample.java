...
public final class JDAExample {

  public static void main(final String[] args) throws InterruptedException {
    final MCAVApi api = MCAV.api();
    api.install();

    final JDA jda = JDABuilder.createDefault("MTM3MjczNDQyNDQwMzE0ODk3MA.Gv7sgZ.3t5njZYT97wAFvM6dHSKjaEh6VZ9IfJRu4jg_0").build();
    jda.awaitReady();
    ...
    final UriSource source = UriSource.uri(URI.create("https://archive.org/download/rick-roll/Rick%20Roll.mp4"));
