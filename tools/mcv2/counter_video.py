"""Make a test video whose every frame carries its own number, for end-to-end latency measurements.
    ...
    python tools/mcv2/counter_video.py <clip.rgb> <width> <height> <fps> <seconds> <out.mp4> [--ffmpeg FFMPEG]
...
keyframe every two seconds), so the blocks survive the player's decoder unchanged.
"""
