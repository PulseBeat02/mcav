 ...
 */
public final class RandomDither extends AbstractDitherAlgorithm {
   ...
   */
  public RandomDither(final Palette palette, final int weight) {
    super(palette);
    this.min = -weight;
    this.max = weight + 1;
  }
   ...
   * @param width the width of the image, used to calculate dimensions and pixel positions
